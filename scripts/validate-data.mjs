...
if (versionedData.datasets.length !== 1 || !/^\d+\.\d+\.\d+ LIVE\.\d+$/.test(versionedData.datasets[0]?.gameVersion ?? "")) {
  console.error("versioned-data.json must contain exactly one exact LIVE dataset");
  process.exitCode = 1;
}
